...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      const { token, role, name, profileId, email, kelasId, namaKelas, userId, isCoAdmin } = response.data;
      localStorage.setItem('token', token);
      localStorage.setItem('user', JSON.stringify({ role, name, profileId, email, kelasId, namaKelas, userId, isCoAdmin }));
